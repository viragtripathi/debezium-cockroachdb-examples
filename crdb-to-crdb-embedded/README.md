...
(`3.7.0.Alpha2`) resolves from Maven Central; if it cannot be resolved, the script falls back to building it from the
...
|-----------------------|------------------|------------------------------------------------------------------------|
| `CONNECTOR_VERSION`   | `3.7.0.Alpha2` | Connector artifact version to resolve from Maven                         |
